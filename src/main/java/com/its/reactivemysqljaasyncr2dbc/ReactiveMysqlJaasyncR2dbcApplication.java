package com.its.reactivemysqljaasyncr2dbc;
...
public class ReactiveMysqlJaasyncR2dbcApplication {

	public static void main(String[] args) {
		SpringApplication.run(ReactiveMysqlJaasyncR2dbcApplication.class, args);
	}
...
class MysqlApplicationConfiguration extends AbstractR2dbcConfiguration {
	...
	public ConnectionFactory connectionFactory() {
		String url = "mysql://root:@127.0.0.1:3306/orders";
